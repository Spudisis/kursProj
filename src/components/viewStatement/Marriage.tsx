...
export const MarriageView = ({ statement }: any) => {
  return (
    <div className={s.wrapper}>
      ...
      <div className={s.twinBlock}>
        <div className={s.twin}>
          ...
          <div className={s.block}>
            <p>Присвоить фамилию:</p>
            <p>{statement.spec.familyM ? statement.spec.familyM : "Не указано"}</p>
          </div>
          <div className={s.block}>
            <p>Предыдущий брак:</p>
            <p>{statement.spec.lastDocM ? statement.spec.lastDocM : "Не указано"}</p>
          </div>
        </div>
        <div className={s.twin}>
          <div>
            ...
            <div className={s.block}>
              <p>Присвоить фамилию:</p>
              <p>{statement.spec.familyW ? statement.spec.familyW : "Не указано"}</p>
            </div>
            <div className={s.block}>
              <p>Предыдущий брак:</p>
              <p>{statement.spec.lastDocW ? statement.spec.lastDocW : "Не указано"}</p>
            </div>
          </div>
        </div>
      </div>
